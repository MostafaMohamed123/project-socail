            ...
            <div class="profile_left">
                <div class="left_wreper">
                    ...
                    <div class="wreper_right">
                        ...
                        {
                        ?>
                        <div class="num_friend" style="margin-left: 15px;"><a href="lists.php?user=<?php echo $username ?>">  <?php echo $num_friends  ?></a> </div>
                        <?php
                        }
                        else
                        {
                        ?>
                        <div class="num_friend" style="margin-left: 15px;"><a href="profile_lists.php?user=<?php echo $username ?>">  <?php echo $num_friends  ?></a> </div>
                      <?php
                        }
                      ?>
                    </div>
             ...
             <div style="margin-left: 885px" class="left_info">
                <div class="left_info_wreper">
                    <div class="lable"> First Name <br>   
                     Last Name   <br>
                     Email   <br>
                     Phone   <br>
                     city  <br>
                     ...
                     <div class="op" style="margin-left: 60px;">
                        <?php echo $user_array['first_name'] ?> <br>
                        <?php echo $user_array['last_name'] ?> <br>
