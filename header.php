...
<div class="header_bar">
    ...
    <span style="font-family: Roboto;/*! text-decoration: none; */font-size: 26px;">Easy Social</span></a>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
            <div class="dropdown-a">
                ...
                <a href="lists.php"> <i class="fas fa-user-plus fa-lg" style="margin-right: 3px;"></i> Lists</a>
                <?php    
                    $user_obj = new User($con, $userLoggedIn);
                    $num_lists = $user_obj->getNumbreOfLists();
                    if ($num_lists > 0){
                        echo "
                            <div class='notification_count' style='background: red; height: 20px; width: 20px; border-radius: 50%; color: white; display: grid; position: relative; margin: -20px 0px 0px 135px;'>
                                <span style='font-size: 10px; text-align: center; margin: 2px 0 0 0;'>"
