...
<?php 
    ...
    class User{
        ...
        public function removeFriend($user_to_remove){
            ...
            $delete_query = mysqli_query($this->con, "delete from friend_lists where user='$logged_in_user' and friend='$user_to_remove'");
        ...
        public function getNumbreOfLists(){
            $userLoggedIn = $this->user['username'];
            $query = mysqli_query($this->con, "SELECT * FROM friend_lists WHERE user='$userLoggedIn'");
             return mysqli_num_rows($query);
        }
