                ...
                while($row = mysqli_fetch_array($data_query)) {
				    ...
				    // if($user_logged_obj->isFriend($added_by)){
                        ...
                        $ret_str .= "
                            ...
                            <div calss='post_feature'style=''>
                                <div class='v comImg_comCount' style='display: flex; float: right; margin: 0 40px;'>
                                ...
                                <iframe src='dislike.php?post_id=$id'style='border: 0px; height: 25px; width: 120px; margin-left: 35px;' scrolling='no'></iframe>
                                </div>
